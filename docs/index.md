...
**TutorTrack provides a CLI-based, lightweight tutor management system**  that allows tutors to:
- Quickly organise student contact details.
- Track lesson schedules.
- Log student progress.

This ensures seamless access to critical information without switching between multiple apps, allowing tutors to focus on teaching while maintaining an organised workflow.
